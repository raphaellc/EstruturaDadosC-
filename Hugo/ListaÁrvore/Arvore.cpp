...
//
//bool Arvore::podar(No * r,No* lock , int v)
//{
//	if (lock == nullptr) {
//		return true;
//	}
//
//	else if (lock->valor == v) {
//		if (r->NoEsq != 0) {
//			podar(r->NoEsq, lock, v);
//		}
//		else if (r->NoDir != 0) {
//			podar(r->NoDir, lock, v);
//		}
//		else {
//			r = nullptr;
//			podar(lock, lock, v);			}
