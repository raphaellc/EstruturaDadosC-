/*2. Crie uma classe chamada “Ingresso” que possui um valor em reais e um método
imprimeValor().
...
mais cara (possui valor adicional). Esta última possui um método para retornar o valor
