...
void Character::getAllStats()
{
	std::cout << "Name: " << this->getName() << "\n";
	std::cout << "Strength: " << this->getStrength() << "\n";
	std::cout << "Dexterity: " << this->getDexterity() << "\n";
	std::cout << "Constitution: " << this->getConstitution() << "\n";
	std::cout << "Intelligence: " << this->getIntelligence() << "\n";
	std::cout << "Wisdom: " << this->getWisdom() << "\n";
	std::cout << "Charisma: " << this->getCharisma() << "\n";
